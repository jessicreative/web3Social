...
exports.fromNanoString = exports.toNanoString = exports.nsToDate = exports.dateToNs = exports.mapPaginatedStream = exports.retry = exports.promiseWithTimeout = exports.sleep = exports.buildUserPrivateStoreTopic = exports.buildUserInviteTopic = exports.buildUserIntroTopic = exports.buildUserContactTopic = exports.buildDirectMessageTopicV2 = exports.buildDirectMessageTopic = exports.buildContentTopic = void 0;
...
const buildUserInviteTopic = (walletAddr) => {
    return (0, exports.buildContentTopic)(`invite-${walletAddr}`);
};
...
function dateToNs(date) {
    return long_1.default.fromNumber(date.valueOf()).multiply(1000000);
}
...
const fromNanoString = (s) => {
    ...
    return nsToDate(long_1.default.fromString(s));
};
