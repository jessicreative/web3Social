...
import { xmtpEnvelope, fetcher } from '@xmtp/proto';
...
export class ConversationV1 {
    ...
    decodeMessage({ message, contentTopic, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { content, contentType, error } = decodeContent(decrypted, this.client);
            return DecodedMessage.fromV1Message(decoded, content, contentType, contentTopic, this, error);
        });
    }
    /**
    ...
    options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const msg = yield MessageV1.encode(this.client.legacyKeys, recipient, payload, timestamp);
...
export class ConversationV2 {
    ...
    decodeMessage(env) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = yield MessageV2.create(msg, header, signed, messageBytes);
            const { content, contentType, error } = decodeContent(signed.payload, this.client);
            return DecodedMessage.fromV2Message(message, content, contentType, env.contentTopic, this, error);
        });
    }
}
function concat(a, b) {
