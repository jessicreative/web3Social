...
export default class Conversations {
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const conversations = [];
            seenPeers.forEach((sent, peerAddress) => conversations.push(new ConversationV1(this.client, peerAddress, sent)));
            for (const sealed of invitations) {
                try {
                    const unsealed = yield sealed.v1.getInvitation(this.client.keys);
                    conversations.push(yield ConversationV2.create(this.client, unsealed, sealed.v1.header));
                }
                catch (e) {
    ...
    newConversation(peerAddress, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const sealedInvite of yield this.client.listInvitations()) {
                ...
                try {
                    ...
                    if (isMatchingContext(context, invite.context)) {
                        return yield ConversationV2.create(this.client, invite, sealedInvite.v1.header);
                    }
                }
                catch (e) {
            ...
            return ConversationV2.create(this.client, invitation, sealedInvite.v1.header);
        });
    }
